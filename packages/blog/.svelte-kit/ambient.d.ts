...
declare module '$env/static/private' {
	...
	export const SECRET_PASSPHRASE_KEY_1: string;
	export const SECRET_PASSPHRASE_KEY_2: string;
	export const SECRET_PASSPHRASE_KEY_3: string;
	export const SECRET_PASSPHRASE_SEED: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_POSTHOG_API_TOKEN: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SECRET_PASSPHRASE_KEY_1: string;
		SECRET_PASSPHRASE_KEY_2: string;
		SECRET_PASSPHRASE_KEY_3: string;
		SECRET_PASSPHRASE_SEED: string;
		POSTGRES_URL: string;
		NVM_INC: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_POSTHOG_API_TOKEN: string;
