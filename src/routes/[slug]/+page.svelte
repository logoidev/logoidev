<script lang="ts">
	...
	import NameAvatarTitle from '../../components/NameAvatarTitle.svelte';
	...
	onMount(() => {
		const pathUserId = window.location.pathname.substring(1);
