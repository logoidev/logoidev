<article class="flex flex-col gap-4 text-xl indent-4">
	...
	<p>
		...
		fun and fulfilling, and yes - it does pay well, but what is next? Will the fruits of my labour
		be valuable not just for me but after I'm gone? I'd love to think there is a path to answer
		these questions positively. Time and time again I remember the words to my favourite super-hero
	...
	<p>
		...
		overwhelming amounts of information, aimlessness, radicalisation, and inability to distinquish
		what is true is at the core — and technology seems to make it all even worse. Yet I am convinced
		it doesn't necessarily have to. <i>"Making a world a better place"</i> is somewhat of a joke in the
		tech community, but I hope there's enough of us there who take it seriously.
	</p>
	...
	<p>
		...
		them? I've come to believe that while science and technology is undoubtedly extremely powerful,
		there are things beyond the rational world that are true, valuable and absolutely necessary for
		us to live a good and prosperous lives, individually and collectively.
	</p>
	...
	<p>
		...
		only type of truth the order is built upon, and quite arguably the unknowable and unprovable is
		far more important than science.
	</p>

	<p>
		My favorite work of art is the Sistine Chapel — I dream to one day see it with my own eyes and
		show it to my son. But how was it made? Is it built on pure science and engineering? Definitely
		thats a big part — it had been beautifully designed by some brilliant architects of the
		Reneisance age, and built by the hands of the people whose names are unknown to most. But what
	...
	<p>
		It hurts to realise that we have not seen anything close to such beauty produced since the
		...
		wiser than we are? Of course these are rethorical questions — but I think most people would
		agree we did lose <i>something</i>.
	</p>

	<p>
		Growing up in a soviet-built boxed utilitarian beehives the only beauty I saw in architecture
		were churches, as even the monuments were reflective of the soviet doctrines. Orthodox churches
		and Chirstian art, are among the only places that were preserved and still hold beauty as
		something valuable, at least in Eastern Europe. After coming to the West, I glipmsed this too,
		but it is so rare. Apart from an occasional beautiful family house I see copy-pasted spread out
		suburbs, like a huge shopping mall that needs you be put in metal boxes on wheels to get
	...
	<p>
		Now our art and beauty is challenged, disrespected and even intentionally destroyed like a
	...
	<p>
		I wrote my masters paper on the topic of ethical computing, which has come to be even more
		relevant with the recent advances in AI and its consumer adoption. More power is given to these
	...
	<p>
		One thing prgoramming teaches you is the importance of abstraction and reliance on solid
		foundations to built anything that works. We are so accustomed to the miracle that things always
	...
	<p>
		...
		is true, solid and working, and protect it at all cost.
	</p>
	...
	<p>
		...
		issues and make people's lives better daily. Personally I regard Google Maps a technological
		...
		nuclear energy. But
		<i>techne</i> can also be used to bring geat sorrow — due to malevolence, corruption, inaction or
